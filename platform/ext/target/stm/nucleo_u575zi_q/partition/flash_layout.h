 ...
 *
 * 0x0000_0000 SCRATCH (64 KB)
 * 0x0001_0000 BL2 - counters (16 KB)
 * 0x0001_4000 BL2 - MCUBoot (88 KB)
 * 0x0002_a000 BL2 NOHDP code (8 KB)
 * 0x0002_c000 OTP area (8 KB)
 * 0x0002_e000 OTP backup area (8 KB)
 * 0x0003_0000 NV counters area (16 KB)
 * 0x0003_4000 Secure Storage Area (16 KB)
 * 0x0003_8000 Internal Trusted Storage Area (16 KB)
 * 0x0003_c000 Secure image     primary slot (384 KB)
 * 0x0009_c000 Non-secure image primary slot (512 KB)
 * 0x0011_c000 Secure image     secondary slot (384 KB)
 * 0x0017_c000 Non-secure image secondary slot (512 KB)
 *
...
#define FLASH_AREA_BL2_NOHDP_CODE_SIZE  (FLASH_AREA_IMAGE_SECTOR_SIZE)
#define FLASH_AREA_OTP_OFFSET           (FLASH_AREA_BL2_NOHDP_OFFSET+FLASH_AREA_BL2_NOHDP_CODE_SIZE)
#define FLASH_AREA_OTP_SIZE             (FLASH_AREA_IMAGE_SECTOR_SIZE)
#define FLASH_AREA_BL2_NOHDP_SIZE       (FLASH_AREA_OTP_SIZE+FLASH_AREA_BL2_NOHDP_CODE_SIZE)
/* OTP backup area occupies one sector after the NOHDP region */
#define FLASH_OTP_BACKUP_SIZE           (FLASH_AREA_IMAGE_SECTOR_SIZE)
...
/* control OTP area alignment (required for sector erase operations) */
#if (FLASH_AREA_OTP_OFFSET % FLASH_AREA_IMAGE_SECTOR_SIZE) != 0
#error "FLASH_AREA_OTP_OFFSET not aligned on FLASH_AREA_IMAGE_SECTOR_SIZE"
#endif

/* Non Volatile Counters definitions - starts after OTP backup area */
#define FLASH_NV_COUNTERS_AREA_SIZE      (FLASH_AREA_IMAGE_SECTOR_SIZE+FLASH_AREA_IMAGE_SECTOR_SIZE)
#define FLASH_NV_COUNTERS_AREA_OFFSET   (FLASH_AREA_BL2_NOHDP_OFFSET+FLASH_AREA_BL2_NOHDP_SIZE+FLASH_OTP_BACKUP_SIZE)
/* Control Non Volatile Counters definitions */
#if (FLASH_NV_COUNTERS_AREA_SIZE % FLASH_AREA_IMAGE_SECTOR_SIZE) != 0
#error "FLASH_NV_COUNTERS_AREA_SIZE not aligned on FLASH_AREA_IMAGE_SECTOR_SIZE"
#endif /*  (FLASH_NV_COUNTERS_AREA_SIZE % FLASH_AREA_IMAGE_SECTOR_SIZE) != 0 */
